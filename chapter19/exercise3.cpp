...
int main()
{
    ...
    std::cout << "\n----------------------------------------------------------------------------------------------------------------------------------------\n" << std::endl;
    std::cout << "set dictionary! (only accept one definition)" << std::endl;
    std::set<MyDictionary> setDictionary;
    setDictionary.insert(MyDictionary("car","a road vehicle with an engine, four wheels, and seats for a small number of people"));
    setDictionary.insert(MyDictionary("impeachment","the act of making a formal statement that a public official might be guilty of a serious offence in connection with his or her job, especially in the US"));
    setDictionary.insert(MyDictionary("establishment","a business or other organization, or the place where an organization operates"));
    setDictionary.insert(MyDictionary("ninja","a Japanese fighter, especially in the past, who moves and acts without being seen and usually carries a short sword"));
    setDictionary.insert(MyDictionary("glasses","two small pieces of special glass or plastic in a frame worn in front of the eyes to improve sight"));
    setDictionary.insert(MyDictionary("glasses","a hard, brittle substance, typically transparent or translucent, made by fusing sand with soda and lime and cooling rapidly. It is used to make windows, drinking containers, and other articles"));
    DisplayMsgs(setDictionary);
